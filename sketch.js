...
let emptyStar_img, oneStar_img, twoStar_img;
var starDisplay;
...
function preload()
{
  ...
  emptyStar_img = loadAnimation('empty.png');
  oneStar_img = loadAnimation('one_star.png');
  twoStar_img = loadAnimation('stars.png');
...
function setup() 
{
  ...
  starDisplay = createSprite(60, 30, 30, 30);
  starDisplay.addAnimation('empty', emptyStar_img);
  starDisplay.addAnimation('one', oneStar_img);
  starDisplay.addAnimation('two', twoStar_img);
...
function colliod(body, sprite, x) 
{
  if (body != null) {
    var d = dist(body.position.x, body,position.y, sprite.position.x, sprite.position.y)
